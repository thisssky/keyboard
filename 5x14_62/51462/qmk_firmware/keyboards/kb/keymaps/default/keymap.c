...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_LCTL, KC_LGUI, KC_LALT, MO(1), KC_SPC, MO(2), KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, KC_PGUP, KC_PGDN),
	...
	KEYMAP(
		...
		KC_LCTL, KC_LSFT, KC_LALT, KC_TRNS, KC_SPC, KC_ENT, KC_BSPC, KC_DEL, KC_TRNS, KC_TRNS, KC_PSCR, KC_INS),

	KEYMAP(
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
		LALT(KC_TAB), LCTL(KC_Q), LCTL(KC_W), KC_TRNS, LCTL(KC_R), LCTL(KC_T), LCTL(KC_Y), KC_TRNS, KC_PGUP, KC_HOME, LCTL(KC_P), KC_TRNS, KC_TRNS,
		...
		KC_LCTL, KC_LGUI, KC_LALT, LT(3,KC_ENT), KC_SPC, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),

	KEYMAP(
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
		KC_TRNS, KC_MS_BTN3, KC_MS_BTN4, KC_MS_UP, KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_ACCEL0, KC_MS_WH_UP, KC_MS_ACCEL1, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_MS_BTN5, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_TRNS, KC_TRNS, KC_MS_BTN1, KC_MS_WH_DOWN, KC_MS_BTN2, KC_MS_ACCEL2, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_TRNS, LCTL(KC_X), LCTL(KC_V), LCTL(KC_C), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
