...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0]=LAYOUT(
		...
		KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_DEL, KC_ENT, KC_BSLS,
	...
	[1]=LAYOUT(
		KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,
		KC_TAB, KC_Q, KC_MS_BTN5, KC_MS_UP, KC_R, KC_T, KC_Y, KC_U, KC_UP, KC_MS_ACCEL1, KC_TRNS, KC_TRNS, LCTL(LALT(KC_DEL)),
		KC_TRNS, KC_MS_BTN4, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_BSPC, KC_DEL, KC_LEFT, KC_DOWN, KC_MS_RIGHT, KC_MS_ACCEL2, LCTL(KC_ENT), KC_TRNS,
		KC_LSFT, KC_Z, KC_X, KC_V, KC_C, KC_B, KC_PGUP, KC_PGDN, LSFT(KC_HOME), LSFT(KC_END), KC_RSFT,
