...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0]=LAYOUT(
		...
		KC_LCTL, KC_LGUI, KC_LALT, MO(2), KC_SPC, LT(3,KC_ENT), LT(4,KC_LEFT), KC_UP, KC_DOWN, KC_RGHT, KC_PGUP, KC_PGDN),
    [1]=LAYOUT(
        KC_ESC, DF(0), KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,
    ...
    [2]=LAYOUT(
		...
		KC_LCTL, KC_LSFT, DF(1), KC_TRNS, LT(6,KC_SPC), LT(3,KC_ENT), LT(4,KC_BSPC), KC_DEL, KC_RSFT, KC_RCTL, KC_PSCR, KC_INS),
    [3]=LAYOUT(
		...
		KC_LCTL, KC_LGUI, MO(4), LT(7,KC_ENT), LT(6,KC_SPC), KC_TRNS, KC_MUTE, KC_VOLU, KC_VOLD, KC_MPLY, KC_RALT, KC_RCTL),
	[4]=LAYOUT(
		LCTL(LSFT(KC_ESC)), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		...
		KC_TRNS, KC_TRNS, MO(5), KC_TRNS, LCTL(KC_SPC), KC_ENT, KC_TRNS, KC_VOLU, KC_VOLD, KC_MPLY, KC_RALT, KC_RCTL),
    [5]=LAYOUT(
